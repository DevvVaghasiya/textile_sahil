...
public final class UMathKt {
    ...
    private static final int m1366minJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1348minOfJ1ME1BU(a, b);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1367mineb3DHEI(long a, long b) {
        return UComparisonsKt.m1356minOfeb3DHEI(a, b);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1364maxJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1336maxOfJ1ME1BU(a, b);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1365maxeb3DHEI(long a, long b) {
        return UComparisonsKt.m1344maxOfeb3DHEI(a, b);
    }
}
