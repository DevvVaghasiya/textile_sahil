...
public final class UStringsKt {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m214unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m477unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m293unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m372unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m293unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m241constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m158boximpl(UByte.m164constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m293unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m241constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m421boximpl(UShort.m427constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m241constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m241constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m241constructorimpl(UInt.m241constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, beforeAdding ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m235boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m320constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (Long.compare(result ^ Long.MIN_VALUE, limitBeforeMul ^ Long.MIN_VALUE) > 0) {
                ...
                limitBeforeMul = UByte$$ExternalSyntheticBackport5.m(-1, uradix);
                if (Long.compare(result ^ Long.MIN_VALUE, limitBeforeMul ^ Long.MIN_VALUE) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m320constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m320constructorimpl(ULong.m320constructorimpl(((long) UInt.m241constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m314boximpl(result);
    }
}
