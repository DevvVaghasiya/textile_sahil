...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1611markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1623constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1610elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    /* renamed from: differenceBetween-fRLX17w  reason: not valid java name */
    public final long m1609differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1608adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1623constructorimpl(LongSaturatedMathKt.m1606saturatingAddpTJri5U(timeMark, duration));
    }
}
