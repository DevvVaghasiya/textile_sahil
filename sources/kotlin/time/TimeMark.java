...
public interface TimeMark {
    ...
    TimeMark m1615minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1616plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1617minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m1616plusLRDsOJo(Duration.m1530unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1511isNegativeimpl($this.m1614elapsedNowUwyO8pc());
        }
