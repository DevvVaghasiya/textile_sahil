...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1455minusLRDsOJo(long duration) {
        ...
        public ComparableTimeMark m1458plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1514plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1456minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m1483equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1510isInfiniteimpl(this.offset)) {
                return Duration.Companion.m1580getZEROUwyO8pc();
            } else {
                long offsetDiff = Duration.m1513minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m1483equalsimpl0(m1456minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1580getZEROUwyO8pc());
        }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1527toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1580getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
