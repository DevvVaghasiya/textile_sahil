...
public final class LongSaturatedMathKt {
    ...
    public static final long m1606saturatingAddpTJri5U(long longNs, long duration) {
        long durationNs = Duration.m1498getInWholeNanosecondsimpl(duration);
        boolean z = true;
        if (((longNs - 1) | 1) == Long.MAX_VALUE) {
            return m1605checkInfiniteSumDefinedPjuGub4(longNs, duration, durationNs);
        }
        if ((1 | (durationNs - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m1607saturatingAddInHalvespTJri5U(longNs, duration);
        }
    ...
    private static final long m1605checkInfiniteSumDefinedPjuGub4(long longNs, long duration, long durationNs) {
        if (!Duration.m1510isInfiniteimpl(duration) || (longNs ^ durationNs) >= 0) {
            return longNs;
        }
    ...
    private static final long m1607saturatingAddInHalvespTJri5U(long longNs, long duration) {
        long half = Duration.m1481divUwyO8pc(duration, 2);
        if ((1 | (Duration.m1498getInWholeNanosecondsimpl(half) - 1)) == Long.MAX_VALUE) {
            return (long) (((double) longNs) + Duration.m1521toDoubleimpl(duration, DurationUnit.NANOSECONDS));
        }
        return m1606saturatingAddpTJri5U(m1606saturatingAddpTJri5U(longNs, half), Duration.m1513minusLRDsOJo(duration, half));
    }

    public static final long saturatingDiff(long valueNs, long originNs) {
        if ((1 | (originNs - 1)) == Long.MAX_VALUE) {
            return Duration.m1530unaryMinusUwyO8pc(DurationKt.toDuration(originNs, DurationUnit.DAYS));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1Ns, long origin2Ns) {
        ...
        if (!(((origin2Ns - 1) | 1) == Long.MAX_VALUE)) {
            ...
            return Duration.m1530unaryMinusUwyO8pc(DurationKt.toDuration(origin2Ns, DurationUnit.DAYS));
        }
    }
    ...
    private static final long saturatingFiniteDiff(long value1Ns, long value2Ns) {
        ...
        if (((result ^ value1Ns) & (~(result ^ value2Ns))) < 0) {
            ...
            return Duration.m1514plusLRDsOJo(duration, DurationKt.toDuration(resultNs, DurationUnit.NANOSECONDS));
        }
