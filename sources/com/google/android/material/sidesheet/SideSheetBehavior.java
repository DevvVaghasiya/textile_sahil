...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    public void setState(int state2) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout((View) this.viewRef.get(), new SideSheetBehavior$$ExternalSyntheticLambda1(this, finalState));
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$setState$0$com-google-android-material-sidesheet-SideSheetBehavior  reason: not valid java name */
    public /* synthetic */ void m121lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(int finalState) {
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new SideSheetBehavior$$ExternalSyntheticLambda0(this, coplanarSiblingLayoutParams, this.sheetDelegate.getCoplanarSiblingAdjacentMargin(coplanarSiblingLayoutParams), coplanarSiblingView);
    }
    ...
    public /* synthetic */ void m120lambda$getCoplanarFinishAnimatorUpdateListener$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(ViewGroup.MarginLayoutParams coplanarSiblingLayoutParams, int coplanarSiblingAdjacentMargin, View coplanarSiblingView, ValueAnimator animation) {
    ...
    class StateSettlingTracker {
        ...
        public /* synthetic */ void m122lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker() {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(int state2) {
        return new SideSheetBehavior$$ExternalSyntheticLambda2(this, state2);
    }
    ...
    public /* synthetic */ boolean m119lambda$createAccessibilityViewCommandForState$2$comgoogleandroidmaterialsidesheetSideSheetBehavior(int state2, View view, AccessibilityViewCommand.CommandArguments arguments) {
        setState(state2);
        return true;
    }
}
