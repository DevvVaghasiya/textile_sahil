...
public class LoadingBiggy extends BaseLinearLoading {
    ...
    public LoadingBiggy(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs, 20, 3, Constant.DEFAULT_COLOR);
    }

    public LoadingBiggy(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView(Context context, AttributeSet attrs, int dotsSize, int dotsCount, int color) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LoadingBiggy);
            setColor(typedArray.getColor(R.styleable.LoadingBiggy_dots_color, Constant.DEFAULT_COLOR));
            setDuration(typedArray.getInt(R.styleable.LoadingBiggy_dots_duration, Constant.DEFAULT_DURATION));
            setDotsCount(typedArray.getInt(R.styleable.LoadingBiggy_dots_count, 3));
            setSize(typedArray.getDimensionPixelSize(R.styleable.LoadingBiggy_dots_size, 20));
        }
    ...
    public void animateView() {
        ...
        while (true) {
            ...
            if (i < i2) {
                PropertyValuesHolder SCALE_X = PropertyValuesHolder.ofFloat(View.SCALE_X, new float[]{1.5f});
                PropertyValuesHolder SCALE_Y = PropertyValuesHolder.ofFloat(View.SCALE_Y, new float[]{1.5f});
