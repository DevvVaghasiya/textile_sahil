...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> $this$toDebugString) {
        ...
        try {
            ...
            str = Result.m146constructorimpl($this$toDebugString_u24lambda_u2d0 + '@' + getHexAddress($this$toDebugString_u24lambda_u2d0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            str = Result.m146constructorimpl(ResultKt.createFailure(th));
        }
        Throwable r2 = Result.m149exceptionOrNullimpl(str);
        if (r2 != null) {
            Throwable th2 = r2;
