...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1695catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m1702catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m1696debounceHG0u8IE(Flow<? extends T> $this$debounce_u2dHG0u8IE, long timeout) {
        return FlowKt__DelayKt.m1698debounceHG0u8IE($this$debounce_u2dHG0u8IE, timeout);
    }
    ...
    public static final <T> Flow<T> m1697sampleHG0u8IE(Flow<? extends T> $this$sample_u2dHG0u8IE, long period) {
        return FlowKt__DelayKt.m1699sampleHG0u8IE($this$sample_u2dHG0u8IE, period);
    }
