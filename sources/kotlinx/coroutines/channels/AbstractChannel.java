...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        if (closed != null) {
            Object list = InlineList.m1708constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                ...
                if (previous instanceof LockFreeLinkedListHead) {
                    ...
                    list = InlineList.m1713plusFjFbRPM(list, (Send) previous);
                }
            }
        } else {
            ...
            while (true) {
                ...
                if (result2 instanceof Closed) {
                    if (((Closed) result2).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m146constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m146constructorimpl(ResultKt.createFailure(((Closed) result2).getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ChannelResult r1 = ChannelResult.m1671boximpl(ChannelResult.Companion.m1684closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m146constructorimpl(r1));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m146constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }
